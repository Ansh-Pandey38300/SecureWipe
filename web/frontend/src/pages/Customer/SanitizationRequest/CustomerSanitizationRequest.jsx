...
export default function CustomerSanitizationRequest() {
  ...
  const summary = useMemo(
    () => ({
      ...
      method: formData.sanitizationMethod || "—",
  ...
  const handleChange = (event) => {
    ...
    if (touched[name]) {
      const validationErrors =
        validateSanitizationForm(updatedFormData);
  ...
  const handleBlur = (event) => {
    ...
    const validationErrors =
      validateSanitizationForm(formData);
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        <div className="rounded-xl border border-green-200 bg-green-50 p-6">
          ...
          <p className="mt-2 text-sm text-green-700">
            REQ-DEMO-001 is mock data only.
          </p>
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-5">
              <SelectField
                ...
                error={errors.sanitizationMethod}
                required
              />
